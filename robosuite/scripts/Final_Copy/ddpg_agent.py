...
class ddpg_agent:
	def __init__(self, args, env, env_params):
		...
		# her sampler
		if args.env_name == 'robosuite':
			self.her_module = her_sampler(self.args.replay_strategy, self.args.replay_k, robo_reward_func=self.env.compute_reward)
		else:
			self.her_module = her_sampler(self.args.replay_strategy, self.args.replay_k, reward_func=self.env.compute_reward)
